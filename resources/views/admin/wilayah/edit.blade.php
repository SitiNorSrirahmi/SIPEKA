        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-sm text-slate-500">
                    Perbarui informasi wilayah rawan <span class="font-medium text-slate-700">{{ $wilayahRawan->kabupaten }}</span>
                </p>
            </div>
            ...
            @endphp
            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-semibold {{ $levelStyle }}">
                <span class="w-2 h-2 rounded-full {{ $levelDot }}"></span>
                {{ $levelLabel }}
            </span>
        </div>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 p-6 sm:p-7">
                        ...
                        <div>
                            ...
                            <textarea name="geom" rows="8"
                                      ...
                                      class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition text-sm font-mono text-slate-900 placeholder:text-slate-500 leading-relaxed resize-y">{{ old('geom', json_encode($wilayahRawan->geom)) }}</textarea>
