...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
    ...
    <div class="flex items-center justify-between gap-3 mb-4 sm:mb-6">
        <div class="flex items-center gap-3 min-w-0">
            ...
            <div class="min-w-0">
                <h1 class="text-base sm:text-xl lg:text-2xl font-bold text-gray-800 truncate">Wilayah Rawan Bencana</h1>
                <p class="text-[11px] sm:text-sm text-gray-500 truncate">Kelola data wilayah rawan bencana di Kalimantan Selatan</p>
            </div>
        </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex items-center gap-1.5 mb-0.5">
                                ...
                                <span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[8px] font-bold uppercase tracking-wide {{ $levelStyle }} shrink-0">
                                    <span class="w-1 h-1 rounded-full {{ $levelDot }}"></span>
                                    {{ $item->level_rawan ?? '-' }}
                                </span>
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const filterBencana = urlParams.get('id_bencana');
    const filterKabupaten = urlParams.get('kabupaten');
                ...
                const FokusControl = L.Control.extend({
                    ...
                    onAdd: function () {
                        ...
                        L.DomEvent.on(btn, 'click', function (e) {
                            ...
                            if (kalselBounds) {
                                map.flyToBounds(kalselBounds, { padding: [20, 20], duration: 1.2 });
                            }
                        });
