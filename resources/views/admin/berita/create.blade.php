                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 lg:p-7">
                    <div class="flex items-center gap-3 mb-4 sm:mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] sm:text-xs text-slate-400">Judul dan isi berita</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 sm:space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="konten" rows="8 sm:rows-10"
                                      placeholder="Tulis isi berita di sini..."
                                      class="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition text-sm text-slate-900 placeholder:text-slate-500 leading-relaxed resize-y">{{ old('konten') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 lg:p-7">
                    <div class="flex items-center gap-3 mb-4 sm:mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] sm:text-xs text-slate-400">Status publikasi berita</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6">
                        <div class="flex items-center gap-3 mb-4 sm:mb-5">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] sm:text-xs text-slate-400">Thumbnail berita</p>
                            </div>
                        </div>
                        ...
                        <div id="preview-container" class="rounded-xl overflow-hidden bg-slate-100 aspect-video mb-3 sm:mb-4">
                            <div id="preview-empty" class="w-full h-full flex flex-col items-center justify-center">
                                ...
                                <p class="text-[10px] sm:text-xs text-slate-400">Belum ada gambar</p>
                            </div>
                        ...
                        {{-- Input File --}}
                        <label class="block text-xs font-semibold text-slate-900 uppercase tracking-wider mb-2">
                            Pilih Gambar <span class="text-slate-400 normal-case tracking-normal font-normal hidden sm:inline">(opsional)</span>
                        </label>
                        ...
                        <p class="text-[10px] sm:text-[11px] text-slate-400 mt-2">Format: JPG, PNG, WEBP. Maks 2MB.</p>
                    </div>
