...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
    ...
    {{-- ==================== MAIN CARD ==================== --}}
    <div class="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 lg:p-8">

        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5 sm:gap-6 lg:gap-8">

            {{-- ============ FOTO ============ --}}
            <div class="lg:col-span-2 lg:order-2">
                <div class="rounded-2xl overflow-hidden bg-slate-100 aspect-video sm:aspect-[3/4] lg:aspect-auto lg:h-full min-h-[240px] sm:min-h-[320px] lg:min-h-[420px]">
                    ...
                    @else
                        <div class="w-full h-full flex flex-col items-center justify-center bg-slate-100">
                            <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-slate-200 flex items-center justify-center mb-2 sm:mb-3">
            ...
            <div class="lg:col-span-3 lg:order-1">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 sm:gap-x-8 gap-y-0">

                    {{-- Token --}}
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs sm:text-sm font-semibold text-slate-900 truncate font-mono">{{ $laporanMasuk->token ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs sm:text-sm font-semibold text-slate-900 truncate">{{ $laporanMasuk->lokasi ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            <p class="text-[10px] sm:text-xs text-slate-400 mb-1">Koordinat</p>
                            <p class="text-xs sm:text-sm font-semibold text-slate-900 font-mono break-all">
                    ...
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            <p class="text-[10px] sm:text-xs text-slate-400 mb-1">Deskripsi</p>
                    ...
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            <p class="text-[10px] sm:text-xs text-slate-400 mb-1">Korban</p>
                    ...
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            <p class="text-[10px] sm:text-xs text-slate-400 mb-1">Estimasi Kerugian</p>
                            <p class="text-xs sm:text-sm font-semibold text-slate-900 truncate">
                    ...
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            <p class="text-[10px] sm:text-xs text-slate-400 mb-1">Tanggal Kejadian</p>
                            <p class="text-xs sm:text-sm font-semibold text-slate-900 truncate">
                    ...
                    <div class="flex items-start gap-3 sm:gap-4 py-4 sm:py-5 border-b border-slate-100">
                        ...
                        <div class="min-w-0">
                            <p class="text-[10px] sm:text-xs text-slate-400 mb-1">Pelapor</p>
                            <p class="text-xs sm:text-sm font-semibold text-slate-900 truncate">
                ...
                {{-- ============ STATUS BOX ============ --}}
                <div class="mt-4 sm:mt-6 rounded-2xl bg-slate-50/70 border border-slate-100 p-4 sm:p-6">
                    <div class="flex items-start gap-3 sm:gap-4">
                        <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-full {{ $boxConfig['iconBg'] }} flex items-center justify-center shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 {{ $boxConfig['iconColor'] }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                    d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                        <div>
                            <p class="text-[10px] sm:text-xs text-slate-400 mb-1">Status</p>
                            <p class="text-base sm:text-xl font-bold text-slate-900 mb-1">{{ $boxConfig['title'] }}</p>
                            <p class="text-xs sm:text-sm text-slate-500">{{ $boxConfig['desc'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @if ($laporanMasuk->status === 'pending')
            <div class="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-slate-100 flex flex-col sm:flex-row gap-2 sm:gap-3">
                <form action="{{ route('admin.laporan.verifikasi', $laporanMasuk->id) }}" method="POST"
                    ...
                    @csrf
                    <button type="submit"
                            class="w-full inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-semibold transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <form action="{{ route('admin.laporan.tolak', $laporanMasuk->id) }}" method="POST"
                    ...
                    @csrf
                    <button type="submit"
                            class="w-full inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-semibold transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
