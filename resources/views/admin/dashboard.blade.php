        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden anim-fade anim-fade-5">
            ...
            <div class="px-4 sm:px-6 pb-2">
                ...
                <div class="flex items-start gap-3 py-3 sm:py-4 border-b border-gray-100">
                    ...
                    <div class="flex-1">
                        <p class="text-xs sm:text-sm text-gray-700 font-medium">Admin memverifikasi laporan</p>
                        <p class="text-[10px] sm:text-xs text-gray-400 mt-1">Baru saja</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 py-3 sm:py-4 border-b border-gray-100">
                    ...
                    <div class="flex-1">
                        <p class="text-xs sm:text-sm text-gray-700 font-medium">Petugas membuat laporan baru</p>
                        <p class="text-[10px] sm:text-xs text-gray-400 mt-1">Baru saja</p>
                    </div>
                </div>

                <div class="flex items-start gap-3 py-3 sm:py-4">
                    <div class="w-2.5 h-2.5 rounded-full bg-purple-500 mt-1.5 shrink-0"></div>
                    <div class="flex-1">
                        <p class="text-xs sm:text-sm text-gray-700 font-medium">Pengguna baru terdaftar</p>
                        <p class="text-[10px] sm:text-xs text-gray-400 mt-1">Baru saja</p>
                    </div>
                </div>
