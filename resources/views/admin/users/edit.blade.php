...
@section('content')
    <div class="max-w-6xl mx-auto px-2">
        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
            ...
            @endphp
            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-semibold {{ $roleStyle }}">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 p-6 sm:p-7">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400">Kosongkan jika tidak ingin mengubah</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                <label class="block text-xs font-medium text-slate-500 uppercase tracking-wider mb-2">
                                    Password Baru <span class="text-slate-400 normal-case tracking-normal font-normal">(opsional)</span>
                                </label>
