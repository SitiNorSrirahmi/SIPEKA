<x-app-layout>
    <div class="p-6 max-w-5xl mx-auto">
        ...
        <form method="GET" class="flex gap-3 mb-4">
            ...
            <input type="text" name="search" placeholder="Cari lokasi..." class="border p-2" value="{{ request('search') }}">

            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded text-sm">Filter</button>
            <a href="{{ route('admin.kejadian.index') }}" class="bg-gray-200 px-4 py-2 rounded text-sm">Reset</a>
        </form>
