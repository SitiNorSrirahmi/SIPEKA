...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ============ WARNA MARKER PER JENIS BENCANA ============
        const markerColor = {
            'banjir': '#1e40af',
            'karhutla': '#991b1b',
            'longsor': '#a16207',
                    ...
                    .then(data => {
                        ...
                        data.forEach(function(item) {
                            ...
                            marker.bindPopup(
                                ...
                                '<a href="/admin/kejadian/' + item.id + '" style="display:inline-flex; align-items:center; gap:4px; padding:6px 12px; border-radius:8px; background:' + warna + '; color:white; font-size:11px; font-weight:700; text-decoration:none;">' +
                                'Detail Kejadian →' +
                                '</a>' +
                                '</div>'
                            );
