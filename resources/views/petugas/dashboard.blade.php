...
<div class="max-w-6xl mx-auto py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Dashboard Petugas SIPEKA</h1>
                <p class="text-sm text-gray-500">Selamat datang kembali, {{ auth()->user()->name ?? 'Petugas' }}!</p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-[10px] uppercase tracking-wider text-gray-500 font-bold">Laporan Saya</p>
                    <p class="text-3xl font-extrabold text-gray-800 mt-1">{{ $totalLaporan }}</p>
                    @if($totalPending > 0)
                    <p class="text-[11px] text-yellow-600 font-semibold mt-0.5">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-[10px] uppercase tracking-wider text-gray-500 font-bold">Terverifikasi</p>
                    <p class="text-3xl font-extrabold text-gray-800 mt-1">{{ $totalVerified }}</p>
                    <p class="text-[11px] text-green-600 font-semibold mt-0.5">
                        ↑ Laporan Anda yang valid
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-[10px] uppercase tracking-wider text-gray-500 font-bold">Kejadian Bencana</p>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-[10px] uppercase tracking-wider text-gray-500 font-bold">Berita</p>
                    <p class="text-3xl font-extrabold text-gray-800 mt-1">{{ $totalBerita }}</p>
                    <p class="text-[11px] text-amber-600 font-semibold mt-0.5">
                        Berita terpublikasi
                    </p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-slate-100 last:border-b-0 hover:bg-blue-50/30 transition-colors">
